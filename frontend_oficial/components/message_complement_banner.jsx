...
export function SvgCarThree(){
    return <svg suppressHydrationWarning
                ...
                -8 666 10 1620 97 434 39 627 50 420 23z`.replace(/\s+/g, " ").trim()}/>
                ...
                -45 -828 395 0 41 5 95 11 119 5 24 8 45 6 48 -3 2 -17 -17 -31 -42z`.replace(/\s+/g, " ").trim()}/>
                ...
                -2 0 -15 -25 -29 -56z`.replace(/\s+/g, " ").trim()}/>
                ...
                245 156 41 81 43 167 6 246 -13 28 -25 52 -27 52 -2 0 -2 -34 0 -76z`.replace(/\s+/g, " ").trim()}/>
                ...
                0 -7 -37z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M3890 4313 c0 -49 41 -738 45 -750 5 -14 134 -87 142 -80 7 8 -42
                831 -51 846 -4 6 -34 11 -72 11 -63 0 -64 0 -64 -27z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M4080 4283 c1 -117 49 -826 57 -833 13 -12 125 -51 131 -45 9 8 -41
                899 -51 913 -6 7 -34 12 -73 12 l-64 0 0 -47z`.replace(/\s+/g, " ").trim()}/>
                ...
                -70 -27z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M4460 4303 c0 -5 11 -222 25 -483 14 -261 25 -478 25 -481 0 -7 141
                -32 146 -26 5 4 -45 969 -51 985 -5 13 -145 18 -145 5z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M6066 4303 l-39 -4 6 -132 c10 -256 40 -842 43 -846 2 -2 10 2 18 8
                26 21 55 97 76 198 39 185 38 592 -3 734 -14 48 -21 51 -101 42z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M4655 4263 c2 -21 14 -243 26 -493 12 -250 25 -459 29 -463 4 -4 38
                -11 76 -14 l70 -6 -4 79 c-2 44 -14 270 -26 504 l-21 425 -78 3 -77 3 5 -38z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M4854 4203 c3 -54 16 -282 27 -508 11 -225 22 -411 22 -412 1 -1 35
                -5 75 -8 l72 -8 0 39 c0 60 -49 976 -52 979 -2 1 -36 5 -77 9 l-74 6 7 -97z`.replace(/\s+/g, " ").trim()}/>
                ...
                -26 493 -26 496 0 4 -10 6 -22 5 -13 -1 -47 -3 -75 -5z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M5050 4238 c1 -79 48 -959 52 -962 9 -8 138 -14 142 -7 5 8 -43 988
                -49 1009 -3 8 -27 12 -75 12 l-70 0 0 -52z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M5247 4283 c-4 -6 19 -483 45 -963 l3 -55 75 0 75 0 -3 40 c-1 22
                -11 229 -22 460 -11 231 -23 444 -26 473 l-5 52 -69 0 c-38 0 -71 -3 -73 -7z`.replace(/\s+/g, " ").trim()}/>
                ...
                0 -70 -27z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M5638 4283 c-6 -12 46 -1000 53 -1007 3 -4 37 -4 75 0 l69 6 -3 77
                c-2 42 -14 267 -26 501 l-21 425 -72 3 c-39 2 -73 -1 -75 -5z`.replace(/\s+/g, " ").trim()}/>
                ...
                0 -5 -32z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M8774 4329 c-9 -15 -58 -838 -51 -846 8 -7 137 66 142 80 3 11 46
                721 45 760 0 14 -10 17 -64 17 -38 0 -68 -5 -72 -11z`.replace(/\s+/g, " ").trim()}/>
                ...
                -69 -3 -75 -6z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M8385 4308 c-5 -16 -52 -952 -48 -957 3 -5 117 19 132 28 8 5 19 150
                36 447 14 241 25 451 25 467 0 27 0 27 -70 27 -48 0 -72 -4 -75 -12z`.replace(/\s+/g, " ").trim()}/>
                ...
                -75 -12z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M6816 4212 c-12 -166 -48 -913 -45 -917 2 -1 36 -5 75 -7 l72 -4 6
                116 c24 439 46 883 44 885 -2 1 -35 5 -74 9 l-72 6 -6 -88z`.replace(/\s+/g, " ").trim()}/>
                ...
                0 c-52 0 -77 -4 -79 -12z`.replace(/\s+/g, " ").trim()}/>
                ...
                -73 4 -46 0 -70 -4 -72 -12z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M7216 4281 c-4 -6 -56 -927 -56 -994 0 -14 11 -17 75 -17 56 0 75 3
                75 13 0 12 25 489 46 885 l6 122 -70 0 c-39 0 -73 -4 -76 -9z`.replace(/\s+/g, " ").trim()}/>
                ...
                -73 7 l-69 0 -5 -42z`.replace(/\s+/g, " ").trim()}/>
                <path d={`M7600 4258 c0 -18 -11 -247 -25 -508 -14 -261 -21 -477 -17 -481 4
                -4 37 -5 74 -2 l67 6 5 71 c8 95 46 850 46 904 l0 42 -75 0 -75 0 0 -32z`.replace(/\s+/g, " ").trim()}/>
                </g>
                </svg>
}