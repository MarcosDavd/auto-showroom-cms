...
export function ComplementBannerHome(){
    return  <section className="complement-banner">
                <div>
                    <h2>Tecnologia, diseño, pasión</h2>
...
function SvgCarOne(){
    return <svg className="svg-cars" viewBox="0 0 1280.000000 720.000000"
...
function SvgCarTwo(){
    return <svg className="svg-cars" viewBox="0 0 1280.000000 640.000000"
                preserveAspectRatio="xMidYMid meet">
                <metadata>
                Created by potrace 1.15, written by Peter Selinger 2001-2017
                </metadata>
